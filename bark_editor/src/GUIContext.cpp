                         ...
                         Color** text_colors)
{
    ...
    drawText(theme->font, name, tab_rect.Center(), OCenter, colorForState(state, text_colors));

    offset += width + theme->tab_spacing;
...
eUIState GUIContext::drawActiveTab(const std::string& name, float& offset)
{
    return drawTab(name, offset, theme->panel_color, theme->panel_border_color, theme->tab_text_colors);
}

eUIState GUIContext::drawInactiveTab(const std::string& name, float& offset)
{
    return drawTab(name, offset, theme->inactive_tab_color, theme->window_color, theme->inactive_tab_text_colors);
}
