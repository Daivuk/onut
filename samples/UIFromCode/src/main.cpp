...
void init()
{
    ...
    pFrame->align = onut::eUIAlign::CENTER;
    ...
    pTitle->align = onut::eUIAlign::TOP;
    pTitle->rect = {{0, 8}, {-16, 24}};
    pTitle->widthType = onut::eUIDimType::DIM_RELATIVE;
    pTitle->textComponent.font.align = onut::eUIAlign::CENTER;
    pTitle->textComponent.font.typeFace = "font.fnt";
    pTitle->textComponent.font.color = onut::sUIColor(1, 1, .5f, 1);
    ...
    pQuitButton->align = onut::eUIAlign::BOTTOM_RIGHT;
